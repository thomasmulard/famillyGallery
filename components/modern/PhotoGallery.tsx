...
export const PhotoGallery: React.FC<PhotoGalleryProps> = ({ photos, users, onSelectPhoto }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4">
      <div className="mb-8 p-4 bg-orange-100/50 dark:bg-slate-800/50 rounded-xl space-y-4">
        <div className="relative">
            <input
                ...
                className="w-full pl-10 pr-4 py-2 text-stone-700 dark:text-stone-200 bg-white/80 dark:bg-slate-700 border border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
            />
